...
name: hyperfocus
description: >
  ADHD-friendly output formatting for Codex. Restructures responses with
...
2. Add a UserPromptSubmit hook to the target settings.json: `{"matcher": "", "command": "cat ~/.claude/hyperfocus-rules.txt"}`
